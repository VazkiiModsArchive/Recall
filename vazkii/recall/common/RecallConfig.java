...
public class RecallConfig extends Configuration {
	...
	public RecallConfig(File file) {
		...
		mod_Recall.recallScroll = new ItemRecallScroll(get("recallScrollID", CATEGORY_ITEM, 4452).getInt(4452)).setIconIndex(1);
		mod_Recall.recallBindstone = new ItemRecallBindstone(get("recallBindstoneID", CATEGORY_ITEM, 4453).getInt(4453)).setIconIndex(0);
		mod_Recall.returnScroll = new ItemReturnScroll(get("returnScrollID", CATEGORY_ITEM, 4454).getInt(4454)).setIconIndex(1);

		Property propOldSchoolMode = get("oldSchoolMode", CATEGORY_GENERAL, false);
		...
		Property propSharedRecalls = get("sharedRecalls", CATEGORY_GENERAL, false);
